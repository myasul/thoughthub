...
type UpdateAction = { type: JournalActionType.Update, date: string, entry: string }
type HydrateAction = { type: JournalActionType.Hydrate, journal: Journal }

export type JournalAction = UpdateAction | HydrateAction
...
const journalReducer: Reducer<Journal, JournalAction> = (journal: Journal, action: JournalAction) => {
    ...
    if (action.type === JournalActionType.Hydrate) {
...
const JournalContext = createContext({} as Journal)
